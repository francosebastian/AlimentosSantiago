<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Master.Master" AutoEventWireup="true" CodeBehind="MenuAdministrativo.aspx.cs" Inherits="AlimentosSantiago.Web.MenuPrincipal" %>
                                                    ...
                                                    <div class="message-form">
                                                        <div class="row">
                                                            <div class="name col-md-12">
                                                                <center>
                                                          <h4>    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Administracion/AgregarCategoriaPlato.aspx">AGREGAR CATEGORIA</asp:HyperLink><br/>
