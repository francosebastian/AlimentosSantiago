<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Master.Master" AutoEventWireup="true" CodeBehind="ModificarPlato.aspx.cs" Inherits="AlimentosSantiago.Web.Administracion.ModificarPlato" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <asp:FormView ID="FvPlato" runat="server" ItemType="AlimentosSantiago.Dto.Plato"
        DataKeyNames="Id" DefaultMode="Edit" SelectMethod="FvPlato_GetItem" UpdateMethod="FvPlato_UpdateItem"
        RenderOuterTable="false">
         <EditItemTemplate>

            <h4>Modificar Plato</h4>
