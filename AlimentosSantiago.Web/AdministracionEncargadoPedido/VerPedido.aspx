                                    ...
                                    <div class="row">
                                        <div class="name col-md-12">
                                            ...
                                            <asp:Panel runat="server" Visible="false" ID="pnlProcesar">
                                                <asp:Label ID="lblRepartidor" runat="server">Seleccionar Repartidor</asp:Label>
                                                <asp:DropDownList ID="ddlRepartidor" runat="server"
                                                    DataSourceID="efTipoUsuario" DataTextField="Nombre" DataValueField="Id"
                                                    ...
                                                    <ef:EntityDataSource ID="efTipoUsuario" runat="server"
                                                        ...
                                                        Select="it.Id,it.Nombre" Where="it.Eliminado = false and it.TipoUsuarioId=5">
                                                    </ef:EntityDataSource>
